  ...
  <div class="site-wrap">
    ...
    <div class="site-section bg-light">
      <div class="container">
        ...
        <div class="row">
         <?php $query=mysqli_query($con,"select * from tblboat ");
$cnt=1;
while($result=mysqli_fetch_array($query)){
?>
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="service-39381">
              <img src="admin/images/<?php echo $result['Image'];?>" alt="Image"  width="100%" height="200">
              <div class="p-4">
                <h3><a href="boat-details.php?bid=<?php echo $result['ID']; ?>">NAME : <?=$result['BoatName']?><br><span class "icon-room mr-1 text-primary"></span> <?php echo $result['Source']?> &mdash; <?php echo $result['Destination']?></a></h3>
                <div class="d-flex">
